...
|---|---|---|
| Ivriel Dei Gratia Gunawan | Project Initiator | Membuat repository, mengatur akses kolaborator, commit `index.html` |
| Raffy Reshaina Pasha | Styling Engineer | Membuat branch `styling`, menambahkan & menghubungkan `style.css` |
| Dinda Octaviani Sofyan | Script Engineer | Membuat branch `scripting`, menambahkan & menghubungkan `script.js` |
